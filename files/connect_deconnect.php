...
<div class='w3-bar w3-theme'>
    <form method='post' action='".htmlspecialchars($_SERVER['PHP_SELF'])."'>
        <button name='deconnexion' class='w3-left w3-bar-item w3-button w3-mobile w3-theme w3-hover-blue-grey' type='submit'><i class='fa fa-sign-out'></i></button>
    </form>
...
<!--
w3-hover-dark-grey w3-button w3-mobile
-->
