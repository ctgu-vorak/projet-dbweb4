    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
        ...
        <div id="modpub" class="switch">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                <div class="w3-margin">
                    <label><b>Pseudo</b></label>
                    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Pseudo" name="mod_pseudo" maxlength="45" value="<?php echo $_SESSION['pseudo']; ?>" readonly required/>

                    <label for="chcat"><b>ID Publications</b></label>
                    <select class="w3-select w3-border" name="mod_id_pub" id="chcat" required>
                    <?php
                        if(isset($db)) {
                            ...
                            echo "</select><br><br>
                            <label><b>Publication</b></label>
                            <textarea style='resize: none' class='w3-input w3-border w3-margin-bottom' name='mod_content' placeholder='Contenu publication' maxlength='250' rows='auto' cols='auto' required></textarea>
                            ";
                        }
                    ?>
                    <p><b>Catégorie</b></p>
                    ...
                    <table style="width: auto">
                        <tr  style="background-color: #ffffff">
                            <td class="w3-left">
                                <input type="radio" name="mod_categorie" value="divers" required/>
                                <label>Divers</label><br>
                            </td>
                        </tr>
                        <tr style="background-color: #ffffff">
                            <td class="w3-left">
                                <input type="radio" name="mod_categorie" value="news" required/>
                                <label>News</label><br>
                            </td>
                        </tr>
                        <tr style="background-color: #ffffff">
                            <td class="w3-left">
                                <input type="radio" name="mod_categorie" value="sport" required/>
                                <label>Sport</label><br>
                            </td>
                        </tr>
                        <tr style="background-color: #ffffff">
                            <td class="w3-left">
                                <input type="radio" name="mod_categorie" value="citation" required/>
                                <label>Citation</label><br>
                            </td>
                        </tr>
                    </table>
                    <div>
                        <table class="w3-table w3-all-centered">
                            <tr style="height: auto">
                                <th>
                                    <button class="w3-button w3-round w3-block w3-green w3-section w3-hover-green" type="submit">Modifier</button>
                                </th>
                                <th>
                                    <button class="w3-button w3-round w3-block w3-red w3-section w3-hover-red" type="reset">Recommencer</button>
                                </th>
